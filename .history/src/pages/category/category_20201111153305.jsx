...
export default class Category extends React.Component{
    ...
    handleOk=async()=>{
      ...
      const categoryNames =this.formRef.current.formRef.current.getFieldsValue().categoryName //1  
          //console.log(this.formRef.current.formRef.current.getFieldsValue().categoryName)
