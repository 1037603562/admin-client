...
import {reqUserLists,reqAddUser,deleteUser} from '../../api/index'
      ...
      this.columns=[
        ...
        },
       {
         ...
         },
         {
           title:'所属角色',
           dataIndex:'_id',
            render:_id=>this.state.roles.find(role=>role._id===_id).name
           //render: role_id => this.roleNames[_id]
          //  render:(_id)=>{
          //   return this.roleNames[_id]
          //   }
         },
         {
           title: '操作',
...
const result =await deleteUser(usertId)
console.log(result,usertId)
if(result.status ===0){
