...
export default class Role extends React.Component{
       ...
       this.columns=[
        ...
        },
        {
          ...
          },
          {
            ...
            width:150,
            render: ()=>{
                return <a href="#" onClick={()=>{this.setState({showStates:true,roleType:1})},console.log(this.state.roleList)}>设置权限</a>
            }
   ...
   handleCancel=()=>{
    ...
    render(){
        ...
        const title =(
            <Button type="primary" onClick={()=>{this.setState({showStates:true,roleType:0})}}>创建角色</Button>
        )
        return  <Card title={title} bordered={false}>
                    ...
                    ></Table>
                    <Modal
                        title={this.state.roleType ===0 ? '添加角色' :'编辑角色'}
                        visible={this.state.showStates}
                        onOk={this.handleOk}
                        onCancel={this.handleCancel}
                    >
                        <AddRoleForm ref={this.formRef} role={this.role}></AddRoleForm>
                    </Modal>
                </Card>
    }
}