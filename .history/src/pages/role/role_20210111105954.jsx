...
export default class Role extends React.Component{
   ...
   addHandleOk=async()=>{
    ...
    const role =this.formRef.current.formRef.current.getFieldsValue().name //1
    console.log('cs---'+this.getSonrole(a))
   ...
   updateHandleOk=()=>{
    ...
    render(){
        ...
        return  <Card title={title} bordered={false}>
                    ...
                    >
                        <AddRoleForm ref={this.formRef} fun={this.getSonrole.bind(this)}></AddRoleForm>
                    </Modal>
