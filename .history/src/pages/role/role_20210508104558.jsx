...
import {reqAddRole,reqRoleLists,setRole,deleteRole} from '../../api'
        ...
        },
        {
          ...
          },
          {
            title: '操作',
                render: (role) => (
                    <span>
                        <a onClick={() => this.showAuth(role)}>设置权限</a> 
                        <a onClick={() => this.deleteRole(role)}>删除角色</a> 
                    </span>
                )
            // render: (role)=>{
...
//    }
   ...
   updateHandleOk=async()=>{//gegn更新角色
        this.setState({showStates2:false,})
            ...
            //qinq请求更新
            //console.log('role------'+role._id+role.name+role.auth_time+role.auth_name)
